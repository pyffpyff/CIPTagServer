 ...
 //	check PLC about all information about source 
  ...
  //source currents
    ...
    public void solvemodel(boolean debugging){
		...
		Y[f][j] = Complex.turnCom(0);
			}		
		}
		Y[0][1] = new Complex(-ya,-xa);
		Y[0][2] = new Complex(-yb,-xb);
		Y[0][3] = new Complex(-yc,-xc);
		...
		if(SOURCE_1_User == 1){
			Y[src1loc][connindex] =new Complex(1,0);	
			SOURCE_1_connindex = connindex;
			connindex++;
			
		}
		if(SOURCE_2_User == 1){
			Y[src2loc][connindex] =new Complex(1,0);	
		...
		for(int i = 0;i<5;i++){
			...
			for(int j = 0;j<5;j++){
				sum =Complex.plus(Y[i][j], sum);
				}
			Y[i][i] = Complex.minus(new Complex(0,0), sum);
		}	
		...
		if(SOURCE_1_User == 1){
			Y[SOURCE_1_connindex][SOURCE_1_connindex] = Complex.times(new Complex(-ro,0), new Complex(SOURCE_1_User,0));
		}
		if(SOURCE_2_User == 1){
			Y[SOURCE_2_connindex][SOURCE_2_connindex] = Complex.times(new Complex(-ro,0), new Complex(SOURCE_2_User,0));
		}
		...
		while (count < maxiter) {
			...
			f1 = Math.abs(v2)*(Complex.abs(Y[1][0])*Math.cos(s2-Complex.phase(Y[1][0]))+Complex.abs(Y[1][1])*Math.abs(v2)*Math.cos(Complex.phase(Y[1][1]))+Complex.abs(Y[1][2])*Math.abs(v3)*Math.cos(s2-s3-Complex.phase(Y[1][2]))+Complex.abs(Y[1][3])*Math.abs(v4)*Math.cos(s2-s4-Complex.phase(Y[1][3])));
			f2 = Math.abs(v3)*(Complex.abs(Y[2][0])*Math.cos(s3-Complex.phase(Y[2][0]))+Complex.abs(Y[2][1])*Math.abs(v2)*Math.cos(s3-s2-Complex.phase(Y[2][1]))+Complex.abs(Y[2][2])*Math.abs(v3)*Math.cos(Complex.phase(Y[2][2]))+Complex.abs(Y[2][3])*Math.abs(v4)*Math.cos(s3-s4-Complex.phase(Y[2][3])));
			f3 = Math.abs(v4)*(Complex.abs(Y[3][0])*Math.cos(s4-Complex.phase(Y[3][0]))+Complex.abs(Y[3][1])*Math.abs(v2)*Math.cos(s4-s2-Complex.phase(Y[3][1]))+Complex.abs(Y[3][2])*Math.abs(v3)*Math.cos(s4-s3-Complex.phase(Y[3][2]))+Complex.abs(Y[3][3])*Math.abs(v4)*Math.cos(Complex.phase(Y[3][3])));
			f4 = Math.abs(v2)*(Complex.abs(Y[1][0])*Math.sin(s2-Complex.phase(Y[1][0]))+Complex.abs(Y[1][1])*Math.abs(v2)*Math.sin(Complex.phase(Y[1][1]))+Complex.abs(Y[2][3])*Math.abs(v3)*Math.sin(s2-s3-Complex.phase(Y[1][2]))+Complex.abs(Y[1][3])*Math.abs(v4)*Math.sin(s2-s4-Complex.phase(Y[1][3])));
			f5 = Math.abs(v3)*(Complex.abs(Y[2][0])*Math.sin(s3-Complex.phase(Y[2][0]))+Complex.abs(Y[2][1])*Math.abs(v2)*Math.sin(s3-s2-Complex.phase(Y[2][1]))+Complex.abs(Y[2][2])*Math.abs(v3)*Math.sin(Complex.phase(Y[2][2]))+Complex.abs(Y[2][3])*Math.abs(v4)*Math.sin(s3-s4-Complex.phase(Y[2][3])));
			f6 = Math.abs(v4)*(Complex.abs(Y[3][0])*Math.sin(s4-Complex.phase(Y[3][0]))+Complex.abs(Y[3][1])*Math.abs(v2)*Math.sin(s4-s2-Complex.phase(Y[3][1]))+Complex.abs(Y[3][2])*Math.abs(v3)*Math.sin(s4-s3-Complex.phase(Y[3][2]))+Complex.abs(Y[3][3])*Math.abs(v4)*Math.sin(Complex.phase(Y[3][3])));
			...
			dp2ds2 = -Math.abs(v2)*(Complex.abs(Y[1][0])*Math.sin(s2-Complex.phase(Y[1][0]))+Complex.abs(Y[1][2])*Math.abs(v3)*Math.sin(s2-s3-Complex.phase(Y[1][2]))+Complex.abs(Y[1][3])*Math.abs(v4)*Math.sin(s2-s4-Complex.phase(Y[1][3])));
			dp2ds3 = Math.abs(v2)*Complex.abs(Y[1][2])*Math.abs(v3)*Math.sin(s2-s3-Complex.phase(Y[1][2]));
			dp2ds4 = Math.abs(v2)*Complex.abs(Y[1][3])*Math.abs(v4)*Math.sin(s2-s4-Complex.phase(Y[1][3]));
			dp2dv2 = Complex.abs(Y[1][0])*Math.cos(s2-Complex.phase(Y[1][0]))+2*Math.abs(v2)*Complex.abs(Y[1][1])*Math.cos(Complex.phase(Y[1][1]))+Complex.abs(Y[1][2])*Math.abs(v3)*Math.cos(s2-s3-Complex.phase(Y[1][2]))+Complex.abs(Y[1][3])*Math.abs(v4)*Math.cos(s2-s4-Complex.phase(Y[1][3]));
			dp2dv3 = Math.abs(v2)*Complex.abs(Y[1][2])*Math.cos(s2-s3-Complex.phase(Y[1][2]));
			dp2dv4 = Math.abs(v2)*Complex.abs(Y[1][3])*Math.cos(s2-s4-Complex.phase(Y[1][3]));
			
			dq2ds2 = Math.abs(v2)*(Complex.abs(Y[1][0])*Math.cos(s2-Complex.phase(Y[1][0]))+Complex.abs(Y[1][2])*Math.abs(v3)*Math.cos(s2-s3-Complex.phase(Y[1][2]))+Complex.abs(Y[1][3])*Math.abs(v4)*Math.cos(s2-s4-Complex.phase(Y[1][3])));
			dq2ds3 = -Math.abs(v2)*Complex.abs(Y[1][2])*Math.abs(v3)*Math.cos(s2-s3-Complex.phase(Y[1][2]));
			dq2ds4 = -Math.abs(v2)*Complex.abs(Y[1][3])*Math.abs(v4)*Math.cos(s2-s4-Complex.phase(Y[1][3]));
			dq2dv2 = Complex.abs(Y[1][0])*Math.sin(s2-Complex.phase(Y[1][0]))-2*Math.abs(v2)*Complex.abs(Y[1][1])*Math.sin(Complex.phase(Y[1][1]))+Complex.abs(Y[1][2])*Math.abs(v3)*Math.sin(s2-s3-Complex.phase(Y[1][2]))+Complex.abs(Y[1][3])*Math.abs(v4)*Math.sin(s2-s4-Complex.phase(Y[1][3]));
			dq2dv3 = Math.abs(v2)*Complex.abs(Y[1][2])*Math.sin(s2-s3-Complex.phase(Y[1][2]));
			dq2dv4 = Math.abs(v2)*Complex.abs(Y[1][3])*Math.sin(s2-s4-Complex.phase(Y[1][3]));
			
			dp3ds2 = Math.abs(v3)*Complex.abs(Y[2][1])*Math.abs(v2)*Math.sin(s3-s3-Complex.phase(Y[2][1]));
			dp3ds3 = -Math.abs(v3)*(Complex.abs(Y[2][0])*Math.sin(s3-Complex.phase(Y[2][0]))+Complex.abs(Y[2][1])*Math.abs(v2)*Math.sin(s3-s2-Complex.phase(Y[2][1]))+Complex.abs(Y[2][3])*Math.abs(v4)*Math.sin(s3-s4-Complex.phase(Y[2][3])));	
			dp3ds4 = Math.abs(v3)*Complex.abs(Y[2][3])*Math.abs(v4)*Math.sin(s3-s4-Complex.phase(Y[2][3]));
			dp3dv2 = Math.abs(v3)*Complex.abs(Y[2][1])*Math.cos(s3-s2-Complex.phase(Y[2][1])); 
			dp3dv3 = Complex.abs(Y[2][0])*Math.cos(s3-Complex.phase(Y[2][0]))+Complex.abs(Y[2][1])*Math.abs(v2)*Math.cos(s3-s2-Complex.phase(Y[2][1]))+2*Math.abs(v3)*Complex.abs(Y[2][2])*Math.cos(Complex.phase(Y[2][2]))+Complex.abs(Y[2][3])*Math.abs(v4)*Math.cos(s3-s4-Complex.phase(Y[2][3]));
			dp3dv4 = Math.abs(v3)*Complex.abs(Y[2][3])*Math.cos(s3-s4-Complex.phase(Y[2][3]));
	
			dq3ds2 = -Math.abs(v3)*Complex.abs(Y[2][1])*Math.abs(v2)*Math.cos(s3-s3-Complex.phase(Y[2][1]));
			dq3ds3 = Math.abs(v3)*(Complex.abs(Y[2][0])*Math.cos(s3-Complex.phase(Y[2][0]))+Complex.abs(Y[2][1])*Math.abs(v2)*Math.cos(s3-s2-Complex.phase(Y[2][1]))+Complex.abs(Y[2][3])*Math.abs(v4)*Math.cos(s3-s4-Complex.phase(Y[2][3])));	
			dq3ds4 = -Math.abs(v3)*Complex.abs(Y[2][3])*Math.abs(v4)*Math.cos(s3-s4-Complex.phase(Y[2][3]));
			dq3dv2 = Math.abs(v3)*Complex.abs(Y[2][1])*Math.sin(s3-s2-Complex.phase(Y[2][1])); 
			dq3dv3 = Complex.abs(Y[2][0])*Math.sin(s3-Complex.phase(Y[2][0]))+Complex.abs(Y[2][1])*Math.abs(v2)*Math.sin(s3-s2-Complex.phase(Y[2][1]))+2*Math.abs(v3)*Complex.abs(Y[2][2])*Math.sin(Complex.phase(Y[2][2]))+Complex.abs(Y[2][3])*Math.abs(v4)*Math.sin(s3-s4-Complex.phase(Y[2][3]));
			dq3dv4 = Math.abs(v3)*Complex.abs(Y[2][3])*Math.sin(s3-s4-Complex.phase(Y[2][3]));
	
			dp4ds2 = Math.abs(v4)*Complex.abs(Y[3][1])*Math.abs(v2)*Math.sin(s4-s2-Complex.phase(Y[3][1]));
			dp4ds3 = Math.abs(v4)*Complex.abs(Y[3][2])*Math.abs(v3)*Math.sin(s4-s3-Complex.phase(Y[3][2]));
			dp4ds4 = -Math.abs(v4)*(Complex.abs(Y[3][0])*Math.sin(s4-Complex.phase(Y[3][0]))+Complex.abs(Y[3][1])*Math.abs(v2)*Math.cos(s4-s2-Complex.phase(Y[3][1]))+Complex.abs(Y[3][2])*Math.abs(v3)*Math.sin(s4-s3-Complex.phase(Y[3][2])));
			dp4dv2 = Math.abs(v4)*Complex.abs(Y[3][1])*Math.cos(s4-s2-Complex.phase(Y[3][1])); 
			dp4dv3 = Math.abs(v4)*Complex.abs(Y[3][2])*Math.cos(s4-s3-Complex.phase(Y[3][2]));
			dp4dv4 = Complex.abs(Y[3][0])*Math.cos(s4-Complex.phase(Y[3][0]))+Complex.abs(Y[3][1])*Math.abs(v2)*Math.cos(s4-s2-Complex.phase(Y[3][1]))+Complex.abs(Y[3][2])*Math.abs(v3)*Math.cos(s4-s3-Complex.phase(Y[3][2]))+2*Math.abs(v4)*Complex.abs(Y[3][3])*Math.cos(Complex.phase(Y[3][3]));
			
			dq4ds2 = -Math.abs(v4)*Complex.abs(Y[3][1])*Math.abs(v2)*Math.cos(s4-s2-Complex.phase(Y[3][1]));
			dq4ds3 = -Math.abs(v4)*Complex.abs(Y[3][2])*Math.abs(v3)*Math.cos(s4-s3-Complex.phase(Y[3][2]));
			dq4ds4 = Math.abs(v4)*(Complex.abs(Y[3][0])*Math.cos(s4-Complex.phase(Y[3][0]))+Complex.abs(Y[3][1])*Math.abs(v2)*Math.cos(s4-s2-Complex.phase(Y[3][1]))+Complex.abs(Y[3][2])*Math.abs(v3)*Math.cos(s4-s3-Complex.phase(Y[3][2])));
			dq4dv2 = Math.abs(v4)*Complex.abs(Y[3][1])*Math.sin(s4-s2-Complex.phase(Y[3][1])); 
			dq4dv3 = Math.abs(v4)*Complex.abs(Y[3][2])*Math.sin(s4-s3-Complex.phase(Y[3][2]));
			dq4dv4 = Complex.abs(Y[3][0])*Math.sin(s4-Complex.phase(Y[3][0]))+Complex.abs(Y[3][1])*Math.abs(v2)*Math.sin(s4-s2-Complex.phase(Y[3][1]))+Complex.abs(Y[3][2])*Math.abs(v3)*Math.sin(s4-s3-Complex.phase(Y[3][2]))+2*Math.abs(v4)*Complex.abs(Y[3][3])*Math.sin(Complex.phase(Y[3][3]));
		...
		COM_MAIN_CURRENT = -(MAIN_VOLTAGE - COM_MAIN_VOLTAGE)*Complex.real(Y[0][1]);
		IND_MAIN_CURRENT = -(MAIN_VOLTAGE - IND_MAIN_VOLTAGE)*Complex.real(Y[0][2]);
		RES_MAIN_CURRENT = -(MAIN_VOLTAGE - RES_MAIN_VOLTAGE)*Complex.real(Y[0][3]);
