  ...
  //source currents
    ...
    public void solvemodel(boolean debugging){
		...
		for (count = 1;count < maxiter;count++) {
			...
			f1 = Math.abs(x[0])*(Math.abs(Y[1][0])*Math.cos(x[3]-Math.atan(xa/ra))+Math.abs(Y[1][1])*Math.abs(x[0])*Math.cos(Math.atan((xa+xx)/(ra+rr)))+Math.abs(Y[1][2])*Math.abs(x[1])*Math.cos(x[3]-x[4]-0)+Math.abs(Y[1][3])*Math.abs(x[2])*Math.cos(x[3]-x[5]-0));
			f2 = Math.abs(x[1])*(Math.abs(Y[2][0])*Math.cos(x[4]-Math.atan(xb/rb))+Math.abs(Y[2][1])*Math.abs(x[0])*Math.cos(x[4]-x[3]-0)+Math.abs(Y[2][2])*Math.abs(x[1])*Math.cos(Math.atan((xb+xx)/(rb+rr)))+Math.abs(Y[2][3])*Math.abs(x[2])*Math.cos(x[4]-x[5]-0));
			f3 = Math.abs(x[2])*(Math.abs(Y[3][0])*Math.cos(x[5]-Math.atan(xc/rc))+Math.abs(Y[3][1])*Math.abs(x[0])*Math.cos(x[5]-x[3]-0)+Math.abs(Y[3][2])*Math.abs(x[1])*Math.cos(x[5]-x[4]-0)+Math.abs(Y[3][3])*Math.abs(x[2])*Math.cos(Math.atan((xc+xx)/(rc+rr))));
			f4 = Math.abs(x[0])*(Math.abs(Y[1][0])*Math.sin(x[3]-Math.atan(xa/ra))+Math.abs(Y[1][1])*Math.abs(x[0])*Math.sin(Math.atan((xa+xx)/(ra+rr)))+Math.abs(Y[2][3])*Math.abs(x[1])*Math.sin(x[3]-x[4]-0)+Math.abs(Y[1][3])*Math.abs(x[2])*Math.sin(x[3]-x[5]-0));
			f5 = Math.abs(x[1])*(Math.abs(Y[2][0])*Math.sin(x[4]-Math.atan(xb/rb))+Math.abs(Y[2][1])*Math.abs(x[0])*Math.sin(x[4]-x[3]-0)+Math.abs(Y[2][2])*Math.abs(x[1])*Math.sin(Math.atan((xb+xx)/(rb+rr)))+Math.abs(Y[2][3])*Math.abs(x[2])*Math.sin(x[4]-x[5]-0));
			f6 = Math.abs(x[2])*(Math.abs(Y[3][0])*Math.sin(x[5]-Math.atan(xc/rc))+Math.abs(Y[3][1])*Math.abs(x[0])*Math.sin(x[5]-x[3]-0)+Math.abs(Y[3][2])*Math.abs(x[1])*Math.sin(x[5]-x[4]-0)+Math.abs(Y[3][3])*Math.abs(x[2])*Math.sin(Math.atan((xc+xx)/(rc+rr))));
			...
			dp2dv2 = Math.abs(Y[1][0])*Math.cos(x[3]-Math.atan(xa/ra))+2*Math.abs(x[0])*Math.abs(Y[1][1])*Math.cos(Math.atan((xa+xx)/(ra+rr)))+Math.abs(Y[1][2])*Math.abs(x[1])*Math.cos(x[3]-x[4]-0)+Math.abs(Y[1][3])*Math.abs(x[2])*Math.cos(x[3]-x[5]-0);
			...
			dq2dv2 = Math.abs(Y[1][0])*Math.sin(x[3]-Math.atan(xa/ra))-2*Math.abs(x[0])*Math.abs(Y[1][1])*Math.sin(Math.atan((xa+xx)/(ra+rr)))+Math.abs(Y[1][2])*Math.abs(x[1])*Math.sin(x[3]-x[4]-0)+Math.abs(Y[1][3])*Math.abs(x[2])*Math.sin(x[3]-x[5]-0);
			dq2dv3 = Math.abs(x[0])*Math.abs(Y[1][2])*Math.sin(x[3]-x[4]-0);
			dq2dv4 = Math.abs(x[0])*Math.abs(Y[1][3])*Math.sin(x[3]-x[5]-0);
			
			dp3ds2 = Math.abs(x[1])*Math.abs(Y[2][1])*Math.abs(x[0])*Math.sin(x[4]-x[3]-0);
			...
			dp3dv3 = Math.abs(Y[2][0])*Math.cos(x[4]-Math.atan(xb/rb))+Math.abs(Y[2][1])*Math.abs(x[0])*Math.cos(x[4]-x[3]-0)+2*Math.abs(x[1])*Math.abs(Y[2][2])*Math.cos(Math.atan((xb+xx)/(rb+rr)))+Math.abs(Y[2][3])*Math.abs(x[2])*Math.cos(x[4]-x[5]-0);
			dp3dv4 = Math.abs(x[1])*Math.abs(Y[2][3])*Math.cos(x[4]-x[5]-0);
	
			dq3ds2 = -Math.abs(x[1])*Math.abs(Y[2][1])*Math.abs(x[0])*Math.cos(x[4]-x[3]-0);
			...
			dq3dv3 = Math.abs(Y[2][0])*Math.sin(x[4]-Math.atan(xb/rb))+Math.abs(Y[2][1])*Math.abs(x[0])*Math.sin(x[4]-x[3]-0)+2*Math.abs(x[1])*Math.abs(Y[2][2])*Math.sin(Math.atan((xb+xx)/(rb+rr)))+Math.abs(Y[2][3])*Math.abs(x[2])*Math.sin(x[4]-x[5]-0);
			...
			dp4dv4 = Math.abs(Y[3][0])*Math.cos(x[5]-Math.atan(xc/rc))+Math.abs(Y[3][1])*Math.abs(x[0])*Math.cos(x[5]-x[3]-0)+Math.abs(Y[3][2])*Math.abs(x[1])*Math.cos(x[5]-x[4]-0)+2*Math.abs(x[2])*Math.abs(Y[3][3])*Math.cos(Math.atan((xc+xx)/(rc+rr)));
			...
			dq4dv4 = Math.abs(Y[3][0])*Math.sin(x[5]-Math.atan(xc/rc))+Math.abs(Y[3][1])*Math.abs(x[0])*Math.sin(x[5]-x[3]-0)+Math.abs(Y[3][2])*Math.abs(x[1])*Math.sin(x[5]-x[4]-0)+2*Math.abs(x[2])*Math.abs(Y[3][3])*Math.sin(Math.atan((xc+xx)/(rc+rr)));
